...
class CoreSettings(BaseAuditModel):
    ...
    # Branding
    brand_name = models.CharField(max_length=255, default="BDO RMM")
    brand_logo = models.ImageField(upload_to="branding/", null=True, blank=True)
    brand_favicon = models.ImageField(upload_to="branding/", null=True, blank=True)
    brand_primary_color = models.CharField(max_length=7, default="#1976D2")
    brand_secondary_color = models.CharField(max_length=7, default="#26A69A")
    brand_accent_color = models.CharField(max_length=7, default="#9C27B0")
    brand_header_color = models.CharField(max_length=50, default="#212121")
    brand_login_bg_start = models.CharField(max_length=7, default="#14141D")
    brand_login_bg_mid = models.CharField(max_length=7, default="#262A38")
    brand_login_bg_end = models.CharField(max_length=7, default="#0F1214")
